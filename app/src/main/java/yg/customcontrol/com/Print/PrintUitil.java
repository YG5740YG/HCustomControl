package yg.customcontrol.com.Print;
...
public class PrintUitil {
    ...
    public static Canvas PrintStringTest(Context ctx, Canvas canvas, CanvsModel
        ...
        Bitmap logo = getImageFromAssetsFile(ctx, "ic_launcher.png");

//        canvas.DrawBox(1, 1, nPrintWidth - 2, nPrintHeight - 2);
        canvas.DrawBitmap(logo, 10, 10, 0);
        canvas.DrawText("title", nPrintWidth / 4, 10, 0, tfTitle, 30, 0x00);
        canvas.DrawText("content", nPrintWidth / 4, 45, 0, tfContent, 20, 0x00);
        ...
        canvas.DrawText("content1:", 5, 175, 0, tfContent, 25, 0x00);
        ...
        canvas.DrawText("content1", (nPrintWidth * 2 / 5 + 5), 175, 0, tfContent, 25, 0x00);
        ...
        canvas.DrawText("content3" + canvsModel.getUpGoodsStation().replace("(content4)", ""), 5, 250, 0,
                tfContent,
                30, 0x00);
        ...
        canvas.DrawText("content6" + canvsModel.getDownGoodsStation().replace("(content5)", ""), 5, 290, 0,
                tfContent, 30, 0x00);
        ...
        canvas.DrawText("content7", 30, 330, 0, tfContent, 30, 0x00);
        canvas.DrawText("content8", (nPrintWidth / 3 + 30), 330, 0, tfContent, 30, 0x00);
        canvas.DrawText("content9", (nPrintWidth * 2 / 3 + 30), 330, 0, tfContent, 30, 0x00);
        ...
        canvas.DrawText(canvsModel.getWeight() + "km", (nPrintWidth / 3 + 30), 370, 0, tfContent, 30, 0x00);
        ...
        canvas.DrawText("content9", 5, 410, 0, tfContent, 30, 0x00);
        canvas.DrawText("content10", 5, 445, 0, tfContent, 30, 0x00);
        canvas.DrawText("content11", 5, 480, 0, tfContent, 30, 0x00);
        canvas.DrawText("content12", 5, 515, 0, tfContent, 30, 0x00);
        ...
        canvas.DrawText("content14", 5, 560, 0, tfContent, 30, 0x00);
