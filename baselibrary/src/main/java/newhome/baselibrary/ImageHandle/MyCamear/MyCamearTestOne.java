...
public class MyCamearTestOne extends Activity implements SurfaceHolder.Callback, View.OnClickListener, Camera.AutoFocusCallback {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.mycamear);
        //获得控件
