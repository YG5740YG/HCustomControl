...
public class InternetMainActivity extends Activity {
        ...
        public void handleMessage(Message msg) {
            ...
            switch (msg.what) {
                case 1:
                    ...
                    Toast.makeText(InternetMainActivity.this, b, Toast.LENGTH_SHORT).show();
                    break;
                case 0:
                    String string = (String) msg.obj;
                    Toast.makeText(InternetMainActivity.this, string, Toast.LENGTH_SHORT)
                            .show();
                    break;
                default:
                    break;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.internet_mainactivity);
        /*
        ...
        gridView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View v,
                ...
                if (position == 0) { // 点击图片位置为+ 0对应0张图片
                    Toast.makeText(InternetMainActivity.this, "添加图片",
                    ...
                    dialog(position);
                    Toast.makeText(InternetMainActivity.this,
    ...
    protected void dialog(final int position) {
        ...
        AlertDialog.Builder builder = new AlertDialog.Builder(InternetMainActivity.this);
