...
//        tabLayout.setSelectedTabIndicatorColor(getResources().getColor(R.color.colorPrimaryDark));
        tableLayout.setSelectedTabIndicatorColor(getResources().getColor(R.color.es_w));
        //为TabLayout添加tab名称
...
//    TableLayoutAndViewPageFragment fragment2;
    private List<Fragment> getFragments() {
        final FragmentManager manager = getFragmentManager();
        final List<Fragment> list = new ArrayList<>();

//        fragment1 = (TableLayoutAndViewPageFragment) manager.findFragmentByTag(TableLayoutAndViewPageFragment.T);
        if (fragment1 == null) {
            fragment1 =new TableLayoutAndViewPageFragment();
        }
//        Bundle bundle1=new Bundle();
//        bundle1.putInt("fragment",1);
//        bundle1.putSerializable("diaoboinDetaailData",homeData);
//        fragment2 = (TableLayoutAndViewPageFragment) manager.findFragmentByTag(homefragment_tw_left.TAG);
        if (fragment2 == null) {
            fragment2 =new TableLayoutAndViewPageFragmentOther();
        }
//        fragment2.setArguments(bundle1);
        Collections.addAll(list, fragment1, fragment2);
//        Collections.addAll(list, fragment1);
        return list;
    }
}
