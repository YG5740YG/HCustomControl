...
public class MyDialog {
    ...
    //弹出提示框
    public MyDialog(Context mcontext,String message,int icon){
    ...
    //弹出提示框，自定义标题
    public MyDialog(Context mcontext,String title,String message,int icon){
    ...
    public MyDialog(Context mcontext,String title,String message,String itemConfirm,DialogInterface.OnClickListener Confirm,int icon){
        final AlertDialog.Builder dialog=create(mcontext,title,message,icon);
        dialog.setPositiveButton(itemConfirm, Confirm);
        mydialog=dialog;
    }
    //弹出提示框，自定义标题,增加两个自定义事件
    public MyDialog(Context mcontext,String title,String message,String itemConfirm,DialogInterface.OnClickListener Confirm
    ...
    public MyDialog(Context mcontext, String title, String message, EditText editText,String itemConfirm,DialogInterface.OnClickListener Confirm
            ,int icon){
        final AlertDialog.Builder dialog=create(mcontext,title,message,icon);
    ...
    //弹出自定义布局dialog提示框
    public MyDialog(Context mcontext,int icon,int layout){
